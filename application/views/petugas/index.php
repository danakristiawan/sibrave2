      ...
      <div class="col">
        <div class="card">
          <div class="card-header">
            <span style="font-size:18px;"><i class="fa fa-folder-o"></i> &nbsp;<a href="<?= base_url('kegiatan'); ?>">Daftar Kegiatan / </a><a href="<?= base_url('kegiatan/sk-index/') . $kegiatan_id; ?>">Daftar Surat Keputusan / </a>Daftar Petugas</span>
                  ...
                  foreach ($petugas as $r) : $no++; ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="<?= base_url('kegiatan/target-edit/') . $kegiatan_id . '/' . $sk_id . '/' . $r['id']; ?>" class="badge badge-warning badge-sm"><i class="fa fa-edit" data-toggle="tooltip" data-placement="bottom" title="Rekam Target"></i></a>
