...
<body style="margin: 0;
  ...
  <div class="container" style="margin-top: 1rem!important; max-width: 1140px; width: 100%;
    ...
    margin-inline-start: 0px;
    margin-inline-end: 0px;">Tinggal selangkah lagi, silahkan tekan tombol dibawah ini untuk melakukan verifikasi akun baru Anda.</p>

        <a href="<?= base_url() . 'auth/verify?email=' . $data['email'] . '&token=' . $data['token']; ?>" class="btn btn-sm btn-primary" style="padding: .25rem .5rem;
    font-size: .875rem;
    line-height: 1.5;
    ...
    vertical-align: middle; user-select: none; border: 1px solid transparent; transition: color .15s ease-in-out,background-color .15s ease-in-out,border-color .15s ease-in-out,box-shadow .15s ease-in-out; text-decoration: none; cursor: pointer;">Verifikasi Akun Saya</a>
