              ...
              <div class="row">
                <div class="col-lg-3">
                  <div class="form-group">
                    <label for="">NIK :</label>
                    <input type="text" name="nik" class="form-control <?= form_error('nik') ? 'is-invalid' : '' ?>" value="<?= $petugas['nik']; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <select name="jabatan" class="form-control">
                      <?php foreach ($jabatan as $r) : ?>
                        <option value="<?= $r['nama']; ?>" <?= $petugas['jabatan'] == $r['nama'] ? 'selected' : ''; ?>><?= $r['nama']; ?></option>
                      <?php endforeach; ?>
                    </select>
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <select name="nama_bank" class="form-control">
                      <?php foreach ($bank as $s) : ?>
                        <option value="<?= $s['nama']; ?>" <?= $petugas['nama_bank'] == $s['nama'] ? 'selected' : ''; ?>><?= $s['nama']; ?></option>
                      <?php endforeach; ?>
                    </select>
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-8">
                  <div class="form-group">
                    ...
                    <input type="text" name="alamat" class="form-control <?= form_error('alamat') ? 'is-invalid' : '' ?>" value="<?= $petugas['alamat']; ?>">
                    <div class="invalid-feedback">
                      <?= form_error('alamat') ?>
                    </div>
                  </div>
